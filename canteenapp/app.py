...
def login():
    ...
    # Fetch ongoing orders from the database
    @app.route('/canteen')
    def canteen():
...
# Route to update order status (manual update)
# @app.route('/update_order_status', methods=['POST'])
# def update_order_status():
#     order_id = request.form['orderid']
#     new_status = request.form['orderstatus']

#     connection = get_db()
#     cursor = connection.cursor()

#     # Update query to change the order status in the database
#     cursor.execute("UPDATE order_table SET orderstatus = %s WHERE orderid = %s", (new_status, order_id))
#     connection.commit()
